 ...
 <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <!-- Sidebar - Brand -->
     <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://localhost/phpmvc/">
     ...
     <div class="sidebar-card d-none d-lg-flex">
         <img class="sidebar-card-illustration mb-2" src="https://pbs.twimg.com/profile_images/415455963278106625/pLe3KVEf_400x400.jpeg" alt="...">
         <p class="text-center mb-2"><strong>Selamat datang di profil</strong> brother :)</p>
